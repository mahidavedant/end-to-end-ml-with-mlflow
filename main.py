...
from mlProject.pipeline.stage_04_model_trainer import ModelTrainerTrainningPipeline
from mlProject.pipeline.stage_05_model_evaluation import ModelEvaluationTrainningPipeline
